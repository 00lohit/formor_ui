  ...
  >
    ...
    <div className="lg:px-16 relative flex flex-col w-full mt-11 px-4">
      <motion.div className="flex flex-col   ">
        ...
        >
          <p className="mb-2">
            At farmor, accessible from https://farmor.ag/, one of our main
            priorities is the privacy of our visitors. This Privacy Policy
            document contains types of information that is collected and
            recorded by farmor and how we use it.
          </p>
          <p className="mb-2">
          ...
          <p className="mb-2">
            ...
            that they shared and/or collect in farmor. This policy is not
      ...
      <motion.div className="flex flex-col   ">
        ...
        >
          <p className="mb-2">
            farmor follows a standard procedure of using log files. These
      ...
      <motion.div className="flex flex-col   ">
        ...
        >
          <p className="mb-2">
            Like any other website, farmor uses 'cookies'. These cookies are
      ...
      <motion.div className="flex flex-col   ">
        ...
        >
          <p className="mb-2">
            ...
            the advertising partners of farmor.
          </p>

          <p className="mb-2">
            Third-party ad servers or ad networks uses technologies like
            cookies, JavaScript, or Web Beacons that are used in their
            respective advertisements and links that appear on farmor, which
          ...
          <p className="mb-2">
            Note that farmor has no access to or control over these cookies
      ...
      <motion.div className="flex flex-col   ">
        ...
        >
          <p className="mb-2">
            farmor's Privacy Policy does not apply to other advertisers or
      ...
      <motion.div className="flex flex-col   ">
        ...
        >
          ...
          <p className="mb-2">
            farmor does not knowingly collect any Personal Identifiable
