...
setTimeout(()=>{
  ...
  return (
    <div className="w-screen h-screen bg-homeBG relative overflow-hidden anton">
      ...
      <div className="flex ">
        <div className="lg:w-1/2" style={{ marginTop: 25 }}>
          <h1
        ...
        >
          <motion.div
            initial={{ position: "absolute", rotate: 0, x: 0, zIndex: 2, y: 0 }}
            animate={{
              rotate: -20,
              x: -130,
              scale: 0.8,
            ...
            transition={delay}
            whileHover={{ scale: 1.1, transition: { delay: 0, duration: 0.35 }, zIndex:4, rotate:0 }}
            onHoverStart={(e) => {}}
            onHoverEnd={(e) => {}}
          ...
          >
            ...
            <div className="m-6 flex items-center justify-center mb-2">
              <h3>Partner App</h3>
            </div>
          </motion.div>
          <motion.div
            ...
            transition={delay}
            whileHover={{ scale: 1.1, transition: { delay: 0, duration: 0.35 } }}
            onHoverStart={(e) => {}}
            onHoverEnd={(e) => {}}
            className="bg-white p-4 w-60 rounded-lg shadow-lg  hover:shadow-2xl"
            style={{ fontFamily: "Montserrat" }}
          ...
          <motion.div
            initial={{ position: "absolute", rotate: 0, x: 0, zIndex: 1, y: 0 }}
